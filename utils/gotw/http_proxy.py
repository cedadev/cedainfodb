...
Adapted from pywebsvcs mailings March/April '08 used in ndg.security.common.zsi
and copied for use here with the NERC Grants on the Web web service client
"""
