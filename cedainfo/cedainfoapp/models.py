...
class Partition(models.Model):
    ...
    def meter(self):
        ...
        s = '<img src="http://chart.googleapis.com/chart?chxt=y&cht=bhs&chd=t:%s,%s,%s&chco=FF0000|00FF00|0000FF&chls=1.0&chs=200x100&chxl=0:|SumOfFileSets|Allocated|UsedCapacity&chm=N*f0*%%,000000,0,-1,11" alt="U:%s%% A:%s%% F:%s%%">' % (used, alloc, filesetsum,used, alloc, filesetsum)
        return s
